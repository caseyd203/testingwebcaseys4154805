...
async function finishStory() {
  ...
  // The final sound starts immediately on the last C press. The End image is
  // not allowed to fade in until end.mp3 has completely finished.
  const endSoundDone = AUDIO?.playSfxUntilEnd('end.mp3', { safetyMs: 30000 }) || Promise.resolve();
